...
echo_and_run cd "/home/smile/nac_sim/src/rotors_simulator/rqt_rotors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/smile/nac_sim/src/rotors_simulator/rqt_rotors/setup.py" \
     \
    build --build-base "/home/smile/nac_sim/build/rotors_simulator/rqt_rotors" \
    install \
    --root="${DESTDIR-/}" \
